...
If you find any valuable researches, please feel free to [pull request](https://github.com/SupeRuier/awesome-active-learning/pulls) ⭐ 1,004 | 🐛 1 | 📅 2026-03-16 or contact [ruihe.cs@gmail.com](ruihe.cs@gmail.com) to update this repository.
...
# Awesome 0. Papers - 当前论文 with stars
...
| --------------------------------------------------------------------------------------------------------------------------------- | ---- | :--------------------------: | ------------- |
| [Active learning and transfer learning at scale with R and Python](https://github.com/Azure/active-learning-workshop) ⚠️ Archived | 2018 |               -              | KDD           |
...
| [modAL](https://github.com/modAL-python/modAL) ⭐ 2,366 \| 🐛 108 \| 🌐 Python \| 📅 2024-02-26                                 | Python(scikit-learn)             | Tivadar Danka             | Keep updating                                    |
| [libact](https://github.com/ntucllab/libact) ⭐ 791 \| 🐛 44 \| 🌐 Python \| 📅 2026-08-21                                      | Python(scikit-learn)             | NTU(Hsuan-Tien Lin group) |                                                  |
| [ALiPy](https://github.com/NUAA-AL/ALiPy) ⭐ 905 \| 🐛 17 \| 🌐 Python \| 📅 2025-07-23                                         | Python(scikit-learn)             | NUAA(Shengjun Huang)      | Include MLAL                                     |
...
| [DeepAL](https://github.com/ej0cl6/deep-active-learning) ⭐ 851 \| 🐛 0 \| 🌐 Python \| 📅 2022-10-03                           | Python(scikit-learn, pytorch)    | Kuan-Hao Huang            | Keep updating & deep neural networks             |
| [BaaL](https://github.com/ElementAI/baal/) ⭐ 933 \| 🐛 20 \| 🌐 Python \| 📅 2025-12-03                                        | Python(scikit-learn, pytorch)    | ElementAI                 | Keep updating & bayesian active learning         |
...
| [Small-text](https://github.com/webis-de/small-text) ⭐ 646 \| 🐛 16 \| 🌐 Python \| 📅 2026-09-24                              | Python(scikit-learn, pytorch)    | Christopher Schröder      | Text classification                              |
